...
static const string mainnet_seeds[] = {"dnsseed.globalpet.exchange", ""};
static const string testnet_seeds[] = {"testnet-seed.globalpet.exchange", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("106.15.94.115", 8801), true);
  }
  do {
